    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified_email', models.BooleanField(default=False, verbose_name='подтвержденная почта')),
                ...
                ('building', models.CharField(blank=True, max_length=16, verbose_name='корпус')),
